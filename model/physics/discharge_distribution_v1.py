...
def Qdist_calc(self, Qall, prt = False):
    ...
    def calc_facQ(key,Av,vol,H):
        facQtot = 0
        for dom in range(self.ch_pars[key]['n_seg']):
            facQtot += (6/5*Av[self.ch_pars[key]['di'][dom]+1]*vol[dom])/(self.g*H[dom]**3)  
    ...
    for key in self.ch_keys:
        ...
        self.ch_pars[key]['facQ'] = calc_facQ(key,self.ch_pars[key]['Av'],self.ch_pars[key]['vol'],self.ch_gegs[key]['Hn'])
